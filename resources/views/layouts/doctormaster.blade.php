    ...
    <aside id="leftsidebar" class="sidebar"> 
        ...
        <div class="menu">
            <ul class="list">
                ...
                <li><a href="{{ url('/InPatient')}}" ><i class="zmdi zmdi-view-array"></i><span>In Patient List</span> </a>
                </li>                                              
                <li><a href="{{ url('/prescription')}}" ><i class="zmdi zmdi-view-array"></i><span>Prescription</span> </a>
                </li>
